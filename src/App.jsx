...
function getVisitedFromUrl() {
  try {
    ...
    return normalizeVisited(states);
  } catch {
    return null;
  }
}
...
function getInitialVisited() {
  ...
  if (visitedFromUrl && visitedFromUrl.length > 0) {
    localStorage.setItem(STORAGE_KEY, JSON.stringify(visitedFromUrl));
    ...
    <div className="page">
      <main className="layout">
        ...
        <aside className="list-panel">
          ...
          <p className="count">
            {visited.length} / {US_STATES.length} visited
          </p>
